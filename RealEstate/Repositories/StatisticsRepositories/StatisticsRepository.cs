...
namespace RealEstate_Api.Repositories.StatisticsRepositories
{
    public class StatisticsRepository : IStatisticsRepository
    {
        ...
        {
            string query = "Select top(1) City, Count(*) as 'ilan sayısı' From Product " +
                 "Group By City order by[ilan sayısı] Desc";
            using (var connection = _context.CreateConnection())
            {
                var values = connection.QueryFirstOrDefault<string>(query);
                return values;
        ...
        {
            string query = "  Select top(1) Name, Count(*) From Product " +
